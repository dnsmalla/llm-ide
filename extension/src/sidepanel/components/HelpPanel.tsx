...
export default function HelpPanel({ onClose }: Props) {
  ...
  for (const s of SECTIONS) {
    ...
    navItems.push(
      ...
      >
        <span className="help-nav-icon" aria-hidden="true"><Icon name={s.icon} /></span>
        {s.title}
      </button>,
    );
  }
      ...
      <div className="help-card">
        ...
        <div className="help-page-overview">
          <div className="help-page-pill">
            <span className="help-pill-icon" aria-hidden="true"><Icon name="mic" /></span>
          ...
          <div className="help-page-pill">
            <span className="help-pill-icon" aria-hidden="true"><Icon name="note" /></span>
          ...
          <div className="help-page-pill">
            <span className="help-pill-icon" aria-hidden="true"><Icon name="question" /></span>
          ...
          <div className="help-page-pill">
            <span className="help-pill-icon" aria-hidden="true"><Icon name="chat" /></span>
          ...
          <div className="help-page-pill">
            <span className="help-pill-icon" aria-hidden="true"><Icon name="gear" /></span>
  ...
  return (
    <div className="help-section">
      <div className="help-page-header">
        <span className="help-page-header-icon" aria-hidden="true"><Icon name="mic" size={22} /></span>
        <div>
...
function NotesPageSection() {
  return (
    <div className="help-section">
      <div className="help-page-header">
        <span className="help-page-header-icon" aria-hidden="true"><Icon name="note" size={22} /></span>
        <div>
          <h3>Notes Page</h3>
          <p className="help-page-tagline">
...
function QuestionsPageSection() {
  return (
    <div className="help-section">
      <div className="help-page-header">
        <span className="help-page-header-icon" aria-hidden="true"><Icon name="question" size={22} /></span>
        <div>
      ...
      <div className="help-card">
        ...
        <div className="help-page-overview">
          <div className="help-page-pill">
            <span className="help-pill-icon" aria-hidden="true"><Icon name="zap" /></span>
          ...
          <div className="help-page-pill">
            <span className="help-pill-icon" aria-hidden="true"><Icon name="check" /></span>
          ...
          <div className="help-page-pill">
            <span className="help-pill-icon" aria-hidden="true"><Icon name="search" /></span>
...
function ChatPageSection() {
  return (
    <div className="help-section">
      <div className="help-page-header">
        <span className="help-page-header-icon" aria-hidden="true"><Icon name="chat" size={22} /></span>
        <div>
          <h3>Chat Page</h3>
          <p className="help-page-tagline">
...
function SettingsPageSection() {
  return (
    <div className="help-section">
      <div className="help-page-header">
        <span className="help-page-header-icon" aria-hidden="true"><Icon name="gear" size={22} /></span>
        <div>
          <h3>Settings Page</h3>
          <p className="help-page-tagline">
