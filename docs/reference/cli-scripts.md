---
title: CLI scripts
source: setup.sh, mac/Scripts/run.sh, extension/start.sh
---
...
| `mac/Scripts/run.sh` | Builds the macOS app (`swift build`), packages it under `/tmp/LlmIdeMac.app`, kills any running instance, opens the app. | Fast iteration on the macOS app during development. |
