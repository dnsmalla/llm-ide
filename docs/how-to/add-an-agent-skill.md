...
> [`dnsmalla/agent-kit`](https://github.com/dnsmalla/agent-kit) repo (`agent-tools/` and
...
In a checkout of [`dnsmalla/agent-kit`](https://github.com/dnsmalla/agent-kit), add the `.md` file to the family that matches:
...
box with the `dnsmalla/agent-kit` marketplace added — it does not fetch from git directly.
