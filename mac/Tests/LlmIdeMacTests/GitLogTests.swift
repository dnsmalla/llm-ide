...
// BlameTests removed: the git-blame feature (and GitLog.parseBlame) was
// deleted in 7d6cd74; this suite referenced the removed API and broke the
// test target's compilation.
