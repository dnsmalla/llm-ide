...
struct DispatchSheet: View {
    ...
    @State private var target: LlmIdeAPIClient.DispatchTarget = .github
    @State private var loadingPreview = true
    @State private var previewError: String?
    @State private var preview: LlmIdeAPIClient.DispatchPreviewResponse?
    ...
    private static let fieldDefs: [LlmIdeAPIClient.DispatchTarget: [(key: String, label: String, secret: Bool)]] = [
    ...
    private func rowView(_ item: LlmIdeAPIClient.DispatchPreviewItem) -> some View {
            ...
            VStack(alignment: .leading, spacing: Spacing.md) {
                HStack(spacing: Spacing.md) {
                    ...
                    Picker("", selection: $target) {
                        ForEach(LlmIdeAPIClient.DispatchTarget.allCases) { t in
    ...
    @ViewBuilder
    private func hint(forTarget t: LlmIdeAPIClient.DispatchTarget) -> some View {
        let copy: String = {
            switch t {
    ...
    private var previewItems: [LlmIdeAPIClient.DispatchPreviewItem] {
        preview?.results ?? []
    }
    ...
    private func providerLabel(_ t: LlmIdeAPIClient.DispatchTarget) -> String {
        let hasSecret: Bool = {
            switch t {
