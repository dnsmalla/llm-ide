...
struct TranscriptView: View {
    ...
    @State private var activeAgentRun: LlmIdeAPIClient.AgentRun?
    ...
    private struct Row: Identifiable {
        ...
        let timestamp: Date
        let origin: Origin
        let meta: LlmIdeAPIClient.LiveCaptionMeta?
        enum Origin {
            case local
            case remote(String?)
    ...
    private func formatTickStatus(_ run: LlmIdeAPIClient.AgentRun?) -> String {
