...
struct AgentDetailView: View {
    ...
    @State private var personas: [LlmIdeAPIClient.AgentPersonaRow] = []
    ...
    @State private var stats: LlmIdeAPIClient.AgentFeedbackStats?

    private var current: LlmIdeAPIClient.AgentPersonaRow? {
