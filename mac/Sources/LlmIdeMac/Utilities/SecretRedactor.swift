...
enum SecretRedactor {
    ...
    private static let patterns: [NSRegularExpression] = {
        ...
        let sources: [(String, Bool)] = [
            (#"\bgh[oprsu]_[A-Za-z0-9]{36}\b"#, false),   // GitHub tokens: ghp_/gho_/ghu_/ghs_/ghr_
            (#"\bgithub_pat_[A-Za-z0-9_]{82}\b"#, false), // GitHub fine-grained PAT
            (#"\bgl(?:pat|oas|rt|cbt|ptt|ft|imt|agent|soat|dt|ffct)-[A-Za-z0-9_-]{20,}\b"#, false), // GitLab tokens (glpat-, glrt-, gldt-, …)
            ...
            (#"\bsk-proj-[A-Za-z0-9_-]{20,}\b"#, false),  // OpenAI project-scoped key
