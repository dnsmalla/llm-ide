...
// without the MeetNotesAPIClient prefix continue to compile.
typealias IngestRequest = MeetNotesAPIClient.IngestRequest
typealias IngestEntity = MeetNotesAPIClient.IngestEntity
