...
final class CodeWorkflowService: ObservableObject {
    ...
    private let log = Logger(subsystem: "com.meetnotes.macapp", category: "CodeWorkflowService")

    // MARK: - Init

    init(project: SavedGitLabProject, api: MeetNotesAPIClient) {
    ...
    func retryMROnly() async {
        ...
        do {
            ...
            Changes applied by MeetNotes AI assistant.
            """
