...
struct HelpGuideView: View {
    ...
    private var gettingStartedContent: some View {
        VStack(alignment: .leading, spacing: Spacing.lg) {
            helpHeader("Welcome to Meet Notes", icon: "hand.wave", tint: .blue)

            helpParagraph("Meet Notes captures live meeting captions from Zoom and Microsoft Teams, then uses AI to generate structured notes, action items, and summaries — so you can focus on the conversation instead of typing.")
            ...
            helpCard("First-time setup", icon: "checkmark.seal") {
                ...
                helpBullet("Sign in with your Meet Notes account (your admin provides the server URL)")
    ...
    private var liveContent: some View {
        VStack(alignment: .leading, spacing: Spacing.lg) {
            ...
            helpCard("During the session", icon: "text.bubble") {
                ...
                helpBullet("You can minimize Meet Notes — capture continues in the background")
            }
    ...
    private var issuesContent: some View {
        VStack(alignment: .leading, spacing: Spacing.lg) {
            ...
            helpParagraph("A kanban-style board that syncs with your linked GitLab or GitHub repository. View, create, and manage issues without leaving Meet Notes.")
    ...
    private var settingsContent: some View {
        VStack(alignment: .leading, spacing: Spacing.lg) {
            ...
            helpCard("App settings", icon: "macwindow") {
                ...
                helpBullet("Server — configure which Meet Notes server to connect to")
    ...
    private var troubleshootingContent: some View {
        VStack(alignment: .leading, spacing: Spacing.lg) {
            ...
            helpCard("Captions aren't being captured", icon: "mic.slash") {
                ...
                helpStep(2, "Make sure Meet Notes is listed and enabled")
            ...
            helpCard("Can't connect to the server", icon: "wifi.exclamationmark") {
                ...
                helpStep(2, "Make sure the Meet Notes server is running")
