...
struct PermissionsView: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: Spacing.xs) {
            ...
            Text("Meet Notes captures meeting captions locally on your Mac. Grant these permissions in System Settings, then quit and relaunch the app.")
    ...
    private var footerHint: some View {
        HStack(alignment: .top, spacing: Spacing.sm) {
            ...
            Text("After enabling Accessibility, **quit and relaunch** Meet Notes — macOS caches the trust state per-process, so the running app will keep saying \"needed\" until restart.")
