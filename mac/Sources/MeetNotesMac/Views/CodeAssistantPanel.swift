...
struct CodeAssistantPanel: View {
    ...
    @State private var attachments: [MeetNotesAPIClient.CodeAttachment] = []
    @State private var history: [MeetNotesAPIClient.CodeAssistTurn] = []
    ...
    private func matchingAttachment(for proposedPath: String)
        -> MeetNotesAPIClient.CodeAttachment?
    {
    ...
    private func persistCurrentSession(history: [MeetNotesAPIClient.CodeAssistTurn]) {
