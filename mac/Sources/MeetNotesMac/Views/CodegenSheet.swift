...
struct CodegenSheet: View {
    ...
    @State private var result: MeetNotesAPIClient.CodegenResult?

    @State private var allowedRepos: [MeetNotesAPIClient.UserRepo] = []
    ...
    @ViewBuilder
    private func content(_ r: MeetNotesAPIClient.CodegenResult) -> some View {
        ScrollView {
    ...
    private func summaryBlock(_ r: MeetNotesAPIClient.CodegenResult) -> some View {
    ...
    private func fileList(_ title: String, files: [MeetNotesAPIClient.CodegenFile]) -> some View {
    ...
    private func submit() async {
        ...
        let pr: MeetNotesAPIClient.CodegenApplySubmitRequest.CodegenApplyPayload.PROptions? =
