...
struct WelcomeView: View {
    ...
    private func actionCards(_ t: Theme) -> some View {
        HStack(alignment: .top, spacing: Spacing.lg) {
            ActionCard(
                ...
                tint: t.accent,
                title: "New Project",
                subtitle: "Pick an empty folder. MeetNotes sets up the workspace and you start fresh.",
                cta: "Choose Folder…",
                theme: t,
                action: newProject)
            ...
            ActionCard(
                ...
                tint: t.accent2,
                title: "Open Existing",
                subtitle: "Resume a MeetNotes project, or adopt a folder you've already cloned.",
                cta: "Open Folder…",
                theme: t,
                action: openExisting)
        }
        ...
        HStack(alignment: .top, spacing: Spacing.sm) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                Text("What counts as a project folder?")
                    ...
                    .foregroundStyle(t.text)
                Text("A project keeps **meetings/**, **notes/**, and **plans/** together with its own settings. Choose an empty folder to start, an existing project to resume, or a cloned code repo — MeetNotes adds what it needs without overwriting your files.")
    ...
    private func openExisting() {
        ...
        panel.message = "Choose a MeetNotes project folder (or a cloned repo) to open."
        open(panel)
    }
