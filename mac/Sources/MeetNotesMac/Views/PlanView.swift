...
struct PlanView: View {
    ...
    /// plan reload.
    @State private var feedbackByTask: [String: MeetNotesAPIClient.AgentFeedbackByTaskItem] = [:]
    ...
    @State private var outcomeByTask: [String: MeetNotesAPIClient.Outcome] = [:]
    ...
    @ViewBuilder
    private func agentFeedbackChip(_ stats: MeetNotesAPIClient.AgentFeedbackByTaskItem) -> some View {
    ...
    /// else is muted.
    @ViewBuilder
    private func outcomeChip(_ o: MeetNotesAPIClient.Outcome) -> some View {
    ...
    private func loadOutcomesEagerly() async {
        ...
        var next: [String: MeetNotesAPIClient.Outcome] = [:]
    ...
    private func loadFeedbackByTask() async {
        if let items = try? await api.getAgentFeedbackByTask() {
            var map: [String: MeetNotesAPIClient.AgentFeedbackByTaskItem] = [:]
