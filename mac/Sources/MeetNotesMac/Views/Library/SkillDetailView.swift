...
struct SkillDetailView: View {
    let skill: MeetNotesAPIClient.SkillEntry
    ...
    private var coreNote: some View {
        noticeRow(
            ...
            body: "This skill is built into the MeetNotes server. It is always available to the agent and cannot be deleted from the Library."
        )
    }
