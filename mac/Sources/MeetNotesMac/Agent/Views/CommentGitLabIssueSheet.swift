...
/// Editable confirmation sheet for the comment-gitlab-issue write tool.
/// Mirrors `CreateGitLabIssueSheet`: the owner provides initial values
/// and a confirm callback; the sheet itself never calls the GitLab API.
struct CommentGitLabIssueSheet: View {
