...
test_check "docs/mobile/quick-start.md exists" "test -f $LLM_IDE_DIR/docs/mobile/quick-start.md"
test_check "docs/mobile/verification.md exists" "test -f $LLM_IDE_DIR/docs/mobile/verification.md"
test_check "compact-mobile-integration.md exists" "test -f $LLM_IDE_DIR/docs/archive/compact-mobile-integration.md"
test_check "mobile-control-complete.md exists" "test -f $LLM_IDE_DIR/docs/archive/mobile-control-complete.md"
